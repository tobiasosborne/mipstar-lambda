...
# verdicts/tb2-r6.md NG7 (brief 69): the N29 variant-(b) all-t line itself.
include("tb1_degenerate_all_t.jl")
...
# verdicts/tb2-r6.md NG3 (brief 69): the swapped (player = :bob) orientation.
