\begin{tikzpicture}[node distance=7mm and 12mm]
  ...
  % a brace between two cells on different rows would be drawn as a diagonal
  % rule straight through the table text; the amber cells already show it.
  \node[lbl, text=focus, anchor=south] at ([yshift=3mm]halt-1-3.north)
    {self-input diagonal};
