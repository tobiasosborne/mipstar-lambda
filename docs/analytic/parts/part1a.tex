...
\begin{figure}[t]
\centering
\input{figs/fig-eq-machine-states}
...
\begin{figure}[t]
\centering
\input{figs/fig-eq-machine-trace}
...
\begin{figure}[t]
\centering
\input{figs/fig-verifier-normal-form}
...
\begin{figure}[t]
\centering
\input{figs/fig-description-bits}
...
\begin{figure}[t]
\centering
\input{figs/fig-timeout-wrapper}
...
\begin{figure}[t]
\centering
\input{figs/fig-universal-machine}
...
\begin{figure}[t]
\centering
\input{figs/fig-halt-f-construction}
\caption{The eight-input machine first accepts a witnessed \(n\)-step halt; otherwise it hardwires \((f,m,L)\), feeds the resulting self-code \(d\) into \((S_L,d)\), compresses, and runs the returned decider.  Green boxes are executed source operations while the dashed slate box is the cited game-theoretic guarantee (after \code{fig:halt_f}).}
