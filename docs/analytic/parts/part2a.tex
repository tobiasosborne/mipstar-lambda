...
the two agree.  All three are strengthenings, not simplifications; the first
two remain open proposed edits to \code{DESIGN.md} \S1.1, so that the two
documents move in lockstep rather than silently diverging.
